...
class _PriceScreenState extends State<PriceScreen> {
  ...
  DropdownButton<String> androidDropdown() { //android style Dropdown for currency list
  ...
  CupertinoPicker iosPicker() { //ios style picker for currency list
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Platform.isIOS ? iosPicker() : androidDropdown(), //select the type of picker based on Platform
          ),
        ],
      ),
    );
